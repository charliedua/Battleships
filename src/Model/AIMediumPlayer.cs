...
namespace MyGame
{
    public class AIMediumPlayer : AIPlayer
    {
        ...
        /// <summary>
        /// GenerateCoordinates should generate random shooting coordinates only when it has not
        /// found a ship, or has destroyed a ship and needs new shooting coordinates
        /// </summary>
        ...
        /// <summary>
        /// ProcessShot will be called uppon when a ship is found. It will create a stack with
        /// targets it will try to hit. These targets will be around the tile that has been hit.
        /// </summary>
