/// <summary>
/// The BattleShipsGame controls a big part of the game. It will add the two players to the game and
/// make sure that both players ships are all deployed before starting the game. It also allows
/// players to shoot and swap turns between player. It will also check if players are destroyed.
/// </summary>
using System;
...
namespace MyGame
{
    ...
    {
        /// <summary>
        /// The attack delegate type is used to send notifications of the end of an attack by a
        /// player or the AI.
        /// </summary>
        ...
        /// <summary>
        /// AddDeployedPlayer adds both players and will make sure that the AI player deploys all ships
        /// </summary>
        /// <param name="p"></param>
        ...
        /// <summary>
        /// Assigns each player the other's grid as the enemy grid. This allows each player to
        /// examine the details visable on the other's sea grid.
        /// </summary>
        ...
        /// <summary>
        /// Shoot will swap between players and check if a player has been killed. It also allows the
        /// current player to hit on the enemygrid.
        /// </summary>
