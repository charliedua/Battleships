/// <summary>
/// The AIPlayer is a type of player. It can readomly deploy ships, it also has the functionality to
/// generate coordinates and shoot at tiles
/// </summary>
using System;
...
namespace MyGame
{
    ...
    {
        /// <summary>
        /// Location can store the location of the last hit made by an AI Player. The use of which
        ...
        /// <summary>
        /// The last shot had the following result. Child classes can use this to prepare for the
        /// next shot.
        /// </summary>
